...
| Package                  | Downloads                                                                                                                                         |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| @edumetz16/agm-core                | [![@edumetz16/agm-core](https://img.shields.io/npm/dm/@edumetz16/agm-core.svg)](https://www.npmjs.com/package/@edumetz16/agm-core)                                              |
...
```shell
npm install @edumetz16/agm-core
```
