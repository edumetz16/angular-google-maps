...
| Package                  | Downloads                                                                                                                                         |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| @edumetz16/agm-core2                | [![@edumetz16/agm-core2](https://img.shields.io/npm/dm/@edumetz16/agm-core2.svg)](https://www.npmjs.com/package/@edumetz16/agm-core2)                                              |
...
```shell
npm install @edumetz16/agm-core2
```
